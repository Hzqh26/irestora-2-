                            ...
                            <ul class="treeview-menu" style="">
                                ...
                                <li class="sub_sub">
                                    ...
                                    <ul class="sub-menu" style="display: none;">
                                        ...
                                        <li data-access="update-40" class="menu_assign_class" data-menu__cid="irp_32"><a href="<?php echo base_url()?>setting/invoicePrinterSetting">
                                                <?php echo lang('invoice_printer_setting'); ?></a></li>
                                        <li data-access="update-43" class="menu_assign_class" data-menu__cid="irp_32"><a href="<?php echo base_url()?>setting/billPrinterSetting">
                                                <?php echo lang('bill_printer_setting'); ?></a></li>
                                        <li data-access="update-46" class="menu_assign_class" data-menu__cid="irp_32"><a href="<?php echo base_url()?>setting/KOTPrinterSetting">
                                                <?php echo lang('kot_printer_setting'); ?></a></li>
                                        <!-- End Sub Menu -->
                                    </ul>
                                </li>
                                ...
                                <li data-access="update-64" class="menu_assign_class" data-menu__cid="irp_32"><a href="<?php echo base_url()?>setting/onlineOrder">
